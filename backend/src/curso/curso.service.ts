...
export class CursoService {
  ...
  async criarCurso(cursoDto: CursoDTO): Promise<{ message: string }> {
    ...
    try {
      ...
      curso.instrutor = await this.instrutorService.buscarInstrutor(cursoDto.id_instrutor);
  ...
  async editarCurso(cursoUpadateDto: CursoUpadateDTO, id: number): Promise<{ message: String }> {
