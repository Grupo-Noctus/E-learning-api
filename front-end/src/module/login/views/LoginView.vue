...
const papel = ref<string>('ADMIN');

const Login = async () => {

  try {

    await submitLogin(email.value as string, password.value as string, papel.value);
  ...
  <div>
    ...
    <v-card class="mx-auto pa-12 pb-8" elevation="8" max-width="448" rounded="lg">
      ...
      <v-card-text class="text-center">
        <router-link to="/cadastro" class="text-blue text-decoration-none">
